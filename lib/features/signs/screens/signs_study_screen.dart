...
class SignsStudyScreen extends StatefulWidget {
  const SignsStudyScreen({super.key});

  @override
  State<SignsStudyScreen> createState() => _SignsStudyScreenState();
}

class _SignsStudyScreenState extends State<SignsStudyScreen> {
  ...
  Widget build(BuildContext context) {
    if (_isLoading) {
      return Scaffold(
        appBar: AppBar(title: const Text('Học Signs')),
